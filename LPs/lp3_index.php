...
<html lang="ar">
	<head>
		...
		<!-- LP MAIN CSS -->
		<link rel="stylesheet" type="text/css" href="lp3/css/lp3_main.css">
		<!--
...
<div class="container">
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="love-heart"></div><!--HEART IMAGE-->
		</div>
		...
		<div id='main_content' style="display: none;">
			...
			<div id="form_not_enriched" class="row">
				...
				<p dir="rtl" class="text-center horoscope">طريق اللعب سر عاشق !!</p>
				<p dir="rtl" class="text-center horoscope">العثور على الحب الحقيقي الخاص بك عن </p>
				<p class="container h-centered txt-center white col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<button dir="rtl" onclick="zeta.onSendAddSubs.call(zeta)" class="lp3_button">الاشتراك</button><!--SUBSCRIBE BUTTON-->
		...
		<div class="row">
			<div id="text_content" class="service-conditions col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<p dir="rtl" class="service-conditions"><a href="lp3_terms.html"><b style="font-size: 4vw;" dir="rtl">الشروط و الأحكام</b></a></p>
		...
		<footer class="fixed-footer text-center">
			<div class="col-xs-12">
				<small><span style="color: white;">Powered by </span><a style="color: #980129;" href="http://zeta-mobile.com" target="_blank">zeta-mobile.com</a></small>
			</div>
		</footer>
