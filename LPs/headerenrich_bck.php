...
<html lang="ar">
	<head>
		...
		?>
		<title>MyAstro Portal Subscription</title>
		<meta charset="utf-8">
...
<div class="container">
	<div class="col-xs-12">
		...
		<div id='main_content' style="display: none;">
			<div id='form_enriched' class="row">
				<button dir="rtl"  onclick="zeta.onSendAddSubs.call(zeta)" class="lp_button">اِكتشف الآن</button><!--SUBSCRIBE BUTTON-->
			</div>
			...
			<div id="redirect_to_contents" class='white h-centered text-center container col-xs-12 col-sm-12 col-md-12 col-lg-12 h-centered'>
				...
				<button class="btn btn-primary" onclick="zeta.onSendAccessSMSLink.call(zeta,true)">Resend SMS with subscription information</button>
			</div>
		...
		<div class="row">
			<div id="text_content" class="service-conditions col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<p dir="rtl" class="service-conditions"><a href="terms_lp.html"><b dir="rtl">الشروط و الأحكام</b></p>
	...
	<script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script><!-- LATEST JQUERY -->
