...
<html lang="ar">
	<head>
		...
		<!-- LP MAIN CSS -->
		<link rel="stylesheet" type="text/css" href="lp4/css/lp4_main.css">
		<!--
...
<div class="container">
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="termometro"></div><!--LP4 MAIN IMAGE-->
		</div>
		...
		<div id='main_content' style="display: none;">
			<div id='form_enriched' class="row">
				<button dir="rtl"  onclick="zeta.onSendAddSubs.call(zeta)" class="lp4_button">اِكتشف الآن</button><!--SUBSCRIBE BUTTON-->
			</div>
			...
			<div id="form_not_enriched" class="row">
				<p dir="rtl" class="text-center horoscope">من ستكون خطيبتك؟</p>
