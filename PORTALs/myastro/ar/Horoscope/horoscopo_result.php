...
<?php 
	...
	$url3=$segments[1];
	$url1= $actual_link;
	if(isset($_GET['src']) && isset($_GET['sign']) && isset($_GET['id'])  && !empty($_GET['src']) && !empty($_GET['sign']) && !empty($_GET['id']) ) {
		$src=$_GET['src'];
		$sign=$_GET['sign'];
		...
		header("Location:".$url1."/".$url2."/horoscope.html");
		exit();
    }
?>
	...
	<div class="row">
		<div class="tag-logo">	
			<div class="col-xs-12 nav-logo">
				<a href="/index.html"><img style="width: 95px; margin-top: 8px;" src="/Horoscope/img/logo_bigger.png"></a>
