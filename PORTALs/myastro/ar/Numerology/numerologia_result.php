<?php include_once '../phpcode/Classes/numerology.php'; ?>
...
<?php 
	...
	if(isset($_POST['submit']) ) {
		if(isset($_POST['day'])&& isset($_POST['month']) && isset($_POST['year'])){
			...
			$nresult=new Numerology();
			$result=$nresult->getData($date);
		}
	}
	else{
		header("Location:".$url1."/".$url2."/Numerology/numerologia.html");
		exit();
    }
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Numerology/css/numerology_result.css">
...
<div class="container">
	...
	<div class="numerologia-result col-xs-12">
		<div class="info-container">
			<div class="number-result"><?php if(isset($date)){echo $date;}?></div>
			<div dir="rtl" class="numerology-result-text"><?php if(isset($result)){echo $result;}?></div>
		</div>
	</div>
