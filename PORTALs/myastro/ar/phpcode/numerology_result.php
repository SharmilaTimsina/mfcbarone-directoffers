<?php include_once 'Classes/numerology.php'; ?>
...
<?php 
	...
	if(isset($_POST['submit']) ) {
		...
		header("Location:".$url1."/".$url2."/".$url3."/Content/numerologia.html");
		exit();
    }
...
<html>
<head>
	<title>Result - Numerologia</title>
...
<div class="container">
	...
	<div class="numerologia-result">
		<div class="info-container">
			<div class="title-result"><?php if(isset($date)){echo $date;}?></div>
