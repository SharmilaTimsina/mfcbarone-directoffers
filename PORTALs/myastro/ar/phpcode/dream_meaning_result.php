<?php include_once 'Classes/dreammeaning.php'; ?>
...
<?php 
	...
	if(isset($_GET['number']) && isset($_GET['title'])) {
		...
		header("Location:".$url1."/".$url2."/".$url3."/Content/dream_meaning.html");
		exit();
    }
...
<html>
<head>
	<title>Result - Dream Meaning</title>
	...
	<link rel="stylesheet" type="text/css" href="../Content/css/dream_meaning_result.css">
</head>
<body>
