<?php include_once '../phpcode/Classes/dreammeaning.php'; ?>
...
<?php 
	...
	$url3=$segments[1];
	$url1= $actual_link;
	if(isset($_GET['number']) && isset($_GET['title'])) {
		$number=$_GET['number'];
		$title=$_GET['title'];
		$dreammeaning=new Dreammeaning();
		$result=$dreammeaning->getData($number);
	}
	else{
		header("Location:".$url1."/".$url2."/Dream Meaning/dream_meaning.html");
		exit();
    }
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Dream Meaning/css/dream_meaning_result.css">
...
<div class="container">
	...
	<div class="dream-result col-xs-12">
		<div class="info-container" style="padding-top:15px;">
			<div class="dream-result-title" dir="rtl">حلم معنى</div>
			<div class="col-xs-12">
				<p class="text-center" style="font-size: 18px; margin-top:10px; color:white;"><?php if(isset($title)) echo $title;?></p>
			</div>
			<div class="col-xs-12">
				<div dir="rtl" class="dream-text-result"><?php if(isset($result)) echo $result;?></br>
				</div>
				</br>
			</div>
	...
	<!--Em Destaque
		...
		<div dir="rtl" class="col-xs-12 searchTest no-result"></div>
