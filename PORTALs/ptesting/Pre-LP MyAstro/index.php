...
<div class="container">
	<div class="col-xs-12">
		...
		<div id='spinner' class="spinner text-center"></div><!--LOADING SPINNER-->
		...
		<div id='main_content' style="display: block;">
			...
			<div id="redirect_to_contents" class='white h-centered text-center container col-xs-12 col-sm-12 col-md-12 col-lg-12 h-centered'>
				...
				<button style="margin-bottom: 10px;" class="btn btn-primary" onclick="zeta.goToContents.call(zeta,true)">Click here to redirect</button>
		...
		<div class="row">
			<div id="text_content" class="service-conditions col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<p dir="rtl" class="service-conditions"><a href="terms_lp.html"><b style="font-size: 4vw;" dir="rtl">الشروط و الأحكام</b></a></p>
