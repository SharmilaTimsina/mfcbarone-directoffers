<?php include_once 'Classes/signcompatibility.php'; ?>
<?php 
	//for address
	...
	if(isset($_POST['first_sign'])&&  !empty($_POST['first_sign']) && isset($_POST['second_sign']) && !empty($_POST['second_sign'])){
		...
		header("Location:".$url1."/".$url2."/".$url3."/Content/compatibilidade_de_signos.html");
		exit();
    }
...
<div class="container">
	...
	<div class="col-xs-12 sign-compatibility-result">
		<div class="info-container" style="padding-top:15px;">
			<div class="signo-title">Sign Compatibility</div>
			<div class="col-xs-12">
				<div class="col-xs-4">
				...
				<p class="name-background"><?php if(isset($arabic_name1)) echo $arabic_name2;?></p>
				</div>
			</div>
			<div class="col-xs-12">
				<div class="result-text"><?php if(isset($result)){echo $result;} ?>
				</div>
			</div>
			<div class="col-xs-12">
